...
class PertanyaanPage2 extends StatefulWidget {
  ...
  const PertanyaanPage2({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu merasa kehilangan kegembiraan dan minat untuk melakukan kegiatan, hobi, atau pekerjaan?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu sering merasa gelisah (merasakan tegang dan cemas berlebih)?',
              _selectedOption2,
              (value) {
                setState(() {
