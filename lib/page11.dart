...
class PertanyaanPage11 extends StatefulWidget {
  static String routeName = 'PertanyaanPage11';
  const PertanyaanPage11({super.key});

  @override
  _PertanyaanPage11State createState() => _PertanyaanPage11State();
}

Answer userAnswers = Answer(answers: {});

class _PertanyaanPage11State extends State<PertanyaanPage11> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu sering merasa terasa nyeri pada otot, nyeri punggung, kaku, gigi gemeruntuk, dan suara tidak stabil?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu merasakan jantung berdebar-debar, telapak tangan basah atau dingin, mulut kering, muka merah, dan mudah berkeringat?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage12');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE17', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE20', _selectedOption2 ?? '');
  }
}