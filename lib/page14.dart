...
class PertanyaanPage14 extends StatefulWidget {
  static String routeName = 'PertanyaanPage14';
  const PertanyaanPage14({super.key});

  @override
  _PertanyaanPage14State createState() => _PertanyaanPage14State();
}

Answer userAnswers = Answer(answers: {});

class _PertanyaanPage14State extends State<PertanyaanPage14> {
 ...
 @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu sering mengalami kesulitan tidur atau tidur lebih sedikit dari biasanya?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu merasa jauh lebih percaya diri daripada biasanya?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage15');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE15', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE29', _selectedOption2 ?? '');
  }
}
