...
class PertanyaanPage7 extends StatefulWidget {
  static String routeName = 'PertanyaanPage7';
  const PertanyaanPage7({super.key});


  @override
   _PertanyaanPage7State createState() => _PertanyaanPage7State();
}

Answer userAnswers = Answer(answers: {});

class _PertanyaanPage7State extends State<PertanyaanPage7> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu pernah merasa seperti sedang bermimpi padahal kamu sedang bangun, atau merasa seperti sedang melihat dirimu sendiri dari luar tubuhmu?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu merasa memiliki pandangan masa depan yang suram dan pesimistis?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: ()  {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage8');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE24', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE10', _selectedOption2 ?? '');
  }
}
