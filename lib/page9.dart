...
class PertanyaanPage9 extends StatefulWidget {
  static String routeName = 'PertanyaanPage9';
  const PertanyaanPage9({super.key});

  @override
  _PertanyaanPage9State createState() => _PertanyaanPage9State();
}

Answer userAnswers = Answer(answers: {});

class _PertanyaanPage9State extends State<PertanyaanPage9> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu sering merasa tertekan di dada, napas pendek/sesak, atau perasaan tercekik?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu sering mati rasa atau kesemutan?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage10');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE19', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE23', _selectedOption2 ?? '');
  }
}
