...
class PertanyaanPage3 extends StatefulWidget {
  static String routeName = 'PertanyaanPage3';
  const PertanyaanPage3({super.key});

  @override
  _PertanyaanPage3State createState() => _PertanyaanPage3State();
}

Answer userAnswers = Answer(answers: {});

class _PertanyaanPage3State extends State<PertanyaanPage3> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu mudah merasa tersinggung atau mudah kaget/terkejut?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu memiliki perasaan bahwa diri sendiri tidak berharga?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage4');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE06', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE09', _selectedOption2 ?? '');
  }
}
