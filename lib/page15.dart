...
class PertanyaanPage15 extends StatefulWidget {
  static String routeName = 'PertanyaanPage15';
  const PertanyaanPage15({super.key});

  @override
  _PertanyaanPage15State createState() => _PertanyaanPage15State();
}
Answer userAnswers = Answer(answers: {});


class _PertanyaanPage15State extends State<PertanyaanPage15> {
 ...
 @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu lebih banyak bicara atau berbicara lebih cepat dari biasanya?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu memiliki lebih banyak energi daripada biasanya?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: ()  {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage16');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE30', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE28', _selectedOption2 ?? '');
  }
}
