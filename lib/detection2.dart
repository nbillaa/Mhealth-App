...
class Tahap2Page extends StatelessWidget {
  static String routeName = 'Tahap2Page';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/bgtahap2.png', // Sesuaikan path gambar
              fit: BoxFit.cover,
            ),
          ),
          SafeArea(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Pertanyaan Gejala berdasarkan Pikiran',
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, 'PertanyaanPage6');
                      },
