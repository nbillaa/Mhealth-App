...
class PertanyaanPage12 extends StatefulWidget {
  static String routeName = 'PertanyaanPage12';
  const PertanyaanPage12({super.key});

  @override
  _PertanyaanPage12State createState() => _PertanyaanPage12State();
}

Answer userAnswers = Answer(answers: {});

class _PertanyaanPage12State extends State<PertanyaanPage12> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildQuestionCard(
              'Apakah kamu sering merasakan mudah lelah dan menurunnya aktivitas?',
              _selectedOption1,
              (value) {
                setState(() {
            ...
            _buildQuestionCard(
              'Apakah kamu memiliki gangguan makan seperti sulit menelan, perut melilit, mual, muntah, kembung, kehilangan berat badan, dan gangguan pencernaan?',
              _selectedOption2,
              (value) {
                setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushNamed(context, 'PertanyaanPage13');
                },
  ...
  void _saveAnswers() {
    ...
    userAnswers.updateAnswer('GE03', _selectedOption1 ?? '');
    userAnswers.updateAnswer('GE18', _selectedOption2 ?? '');
  }
}
